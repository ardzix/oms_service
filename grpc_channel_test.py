...
def run():
    with grpc.insecure_channel(f'{settings.OMS_CHANNEL_SERVICE_HOST}:{settings.OMS_CHANNEL_SERVICE_PORT}') as channel:
        ...
        list_products_request = oms_channel_pb2.ListProductsRequest(channel_hash="fbb7d89c-be1a-47ac-bf2d-7ecce29295ab", event_hash="c357ed38-b8dc-4739-9440-958fcab017cf")
