...
def run():
    with grpc.insecure_channel(f'{settings.OMS_CHANNEL_SERVICE_HOST}:{settings.OMS_CHANNEL_SERVICE_PORT}') as channel:
        ...
        create_product_request = oms_channel_pb2.CreateProductRequest(
            ...
            channel_hash="955d3745-506f-4ba6-88f8-79b779282a5d",
            event_hash="7eb537bd-1d90-4deb-be78-503dc5e2185b",  # Optional
        ...
        get_product_request = oms_channel_pb2.GetProductRequest(product_hash="e5712557-2a37-481e-bf69-679c708a7398")
        ...
        list_products_request = oms_channel_pb2.ListProductsRequest(channel_hash="955d3745-506f-4ba6-88f8-79b779282a5d")
        ...
        create_variant_request = oms_channel_pb2.CreateProductVariantRequest(
            parent_hash="e5712557-2a37-481e-bf69-679c708a7398",
        ...
        list_variants_request = oms_channel_pb2.ListProductVariantsRequest(parent_hash="e5712557-2a37-481e-bf69-679c708a7398")
        ...
        # Delete the product
        delete_product_request = oms_channel_pb2.DeleteProductRequest(product_hash="e5712557-2a37-481e-bf69-679c708a7398")
